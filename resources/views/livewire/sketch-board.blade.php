<div class="min-h-screen bg-gray-50">
    ...
    <div class="fixed top-0 left-0 right-0 bg-white shadow-md z-10 px-4 py-3">
        <div class="max-w-7xl mx-auto flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex items-center space-x-4">
                ...
                <button x-data @click="$wire.imageData = $refs.canvas.toDataURL(); $wire.saveDrawing()"
    ...
    <div x-data="{
        ...
        setCanvasSize(maintainContent = false) {
            const toolbarHeight = 80 // Height of the toolbar
            const padding = 32 // Padding from bottom and sides
    
            // If we want to maintain content, we need to copy the current canvas
            let tempCanvas
            if (maintainContent) {
        ...
        draw(e) {
            ...
            this.ctx.strokeStyle = $wire.isEraser ? 'white' : $wire.currentColor
        ...
        <canvas x-ref="canvas" @mousedown="startDrawing" @mousemove="draw" @mouseup="stopDrawing"
            ...
            class="mx-auto bg-white rounded-lg shadow-lg border border-gray-200"></canvas>
    </div>
</div>
