<div>
    <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div class="min-h-screen bg-white" wire:ignore x-data="sketchBoard($wire)">
            <!-- Floating toolbar -->
            <div class="fixed top-24 left-1/2 transform -translate-x-1/2 z-20">
            ...
            document.addEventListener('alpine:init', () => {
                Alpine.data('sketchBoard', ($wire) => ({
                    ...
                    setCanvasSize(maintainContent = false) {
                        ...
                        let tempCanvas;
                        if (maintainContent && this.canvas.width > 0 && this.canvas.height >
                            0) { // Check if canvas has dimensions
